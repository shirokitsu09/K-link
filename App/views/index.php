    ...
    <div class="background">
                ...
                <div class="group-parent">
                    <div class="ellipse-parent">
                        ...
                        <a id="link" href="hobby-home.php">
                            <img class="MainIcon" alt="" src="../public/HobbyIcon.svg" />
                        </a>
                    </div>
        ...
        <script>
            function changeImg() {
                ...
                if (mainIcon.src.match('../public/HobbyIcon.svg')) {
                    mainIcon.src = '../public/LibraryIcon.svg';
                    content.textContent = 'Library';
                    content.className = 'Librarycontent';
                    link.href = 'library-home.php';
                } else if (mainIcon.src.match('../public/LibraryIcon.svg')) {
                    mainIcon.src = '../public/HobbyIcon.svg';
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slide first">
                        <img src="../public/advertise1.svg" alt="">
                    </div>
                    <div class="slide">
                        <img src="../public/advertise2.svg" alt="">
                    </div>
                    <div class="slide">
                        <img src="../public/advertise3.svg" alt="">
                    </div>
        ...
        <div id="leftArrowAds" class="LeftArrowAds">
            <div class="rectangle-left">
                <img class="vector-icon" alt="" src="../public/LeftArrowAds.svg" />
            </div>
        </div>

        <div id="rightArrowAds" class="RightArrowAds">
            <div class="rectangle-right">
                <img class="vector-icon" alt="" src="../public/RightArrowAds.svg" />
            </div>
        </div>
