...
<html>
  ...
  <body>
    ...
    <div class="HEADER-EAG">
    <a href="./hobbyAboutGroup.php?hID=<?php echo $hID;?>">
    <img class="app-icon-EAG" id="backButton" alt="" src="../images/backbutton.svg" />
    </a>
    <div class="name-header-EAG" id="name-header">แก้ไขกลุ่ม</div>
    <div class="noti-button-icon-EAG">
