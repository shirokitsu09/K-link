...
?>
    ...
    <body>
        <div class="background">
            ...
            <div class="HEADER">
                <a1 href="javascript:history.back()"><img class="app-icon" id="backButton" alt="" src="../images/backbutton.svg" />
                </a1>
                <div class="name-header" id="name-header">คำขอเข้าร่วมกลุ่ม</div>
            ...
            <?php if ($countHobbyrequest > 0) { ?>
                ...
                <div class="groupname" style="padding: 0px 50px;">
                    <p1>ไม่มีคำขอเข้าร่วมกลุ่ม</p1>
                </div>
