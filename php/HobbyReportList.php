...
<body>
  ...
  <div class="report-popup" id="report-popup-h">
    ...
    <textarea placeholder="รายละเอียดเพิ่มเติม..." class="report-description" id="reportDescription_h" method=""
      action="">
      </textarea>
  ...
  <script>
    ...
    function clearReport(e) {
      var reportTopic = "";
      var reportDescription_h = document.getElementById("reportDescription_h").value = "";
    }
    ...
    confirmreport_hobby.addEventListener("click", function (e) {
      reportDescription_h = document.getElementById("reportDescription_h").value;
      console.log("Report ", reportTopic, " : ", reportDescription_h);
      tpopupReport_close_hobby();
      reportpopup_close_h();
    });
